...
public extension MagicJSON {
    ...
    func callAsFunction(transform: (inout Self) -> Void) -> Self {
        var instance = MJ.dict([:])
        transform(&instance)
        return instance
    }
...
//protocol ClosureInstantiable: Initable {
//    func callAsFunction(transform: (inout Self) -> Void) -> Self
//}
//
//extension ClosureInstantiable {
//    func callAsFunction(transform: (inout Self) -> Void) -> Self {
...
//}
//
//extension MagicJSON: ClosureInstantiable {}
