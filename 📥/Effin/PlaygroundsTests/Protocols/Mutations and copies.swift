...
/////
//fileprivate func update(ingredient: ShoppingListItem) {}
/////
///// The goal is to have an api that accepts a whole modified item, which allows chaining changes.
///// Ex.)
/////
...
/// Notas, a explorar, para casos edgy, se podría incluso tener un objeto update command:

struct ShoppingItemUpdateCommand {
    var name: String?
    var isChecked: Bool?
    var measureUnitId: Int?
    var quantity: Double?
